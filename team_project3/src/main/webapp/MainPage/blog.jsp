	...
	<header class="header-v4">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="label1" data-label1="hot">
								<a href="shoping_cart.jsp">Features</a>
							</li>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="shoping_cart.jsp" class="label1 rs1" data-label1="hot">Features</a>
				</li>
			...
			<div class="row">
				<div class="col-md-8 col-lg-9 p-b-80">
					<div class="p-r-45 p-r-0-lg">
						<!-- item blog -->
						<div class="p-b-63">
							<a href="blog_detail.jsp" class="hov-img0 how-pos5-parent">
							...
							<div class="p-t-32">
								<h4 class="p-b-15">
									<a href="blog_detail.jsp" class="ltext-108 cl2 hov-cl1 trans-04">
								...
								<div class="flex-w flex-sb-m p-t-18">
									...
									<a href="blog_detail.jspl" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
										Continue Reading
						...
						<div class="p-b-63">
							...
							<div class="p-t-32">
								...
								<div class="flex-w flex-sb-m p-t-18">
									...
									<a href="blog_detail.jsp" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
										Continue Reading
