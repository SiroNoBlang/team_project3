...
<body class="animsition">
	...
	<!-- Product Detail -->
	<form action="SellWritePro.pr?sell_member_code=<%=sell_member_code%>"
		name="sellForm" method="post" enctype="multipart/form-data">
		<section class="sec-product-detail bg0 p-t-65 p-b-60">
			<div class="container">
				<h3>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<%=member_nickname%>님의 판매글 작성
				</h3>
				<div class="row">
...
.slide_pagination .dot a {
	...
	height: 100%;
											...
											<script type="text/javascript">
												(function() {
													const slideList = document
															.querySelector('.slide_list'); // Slide parent dom
													const slideContents = document
															.querySelectorAll('.slide_content'); // each slide dom
													const slideBtnNext = document
															.querySelector('.slide_btn_next'); // next button
													const slideBtnPrev = document
															.querySelector('.slide_btn_prev'); // prev button
													const pagination = document
															.querySelector('.slide_pagination');
													const slideLen = slideContents.length; // slide length
													const slideWidth = 400; // slide width
													const slideSpeed = 300; // slide speed
													const startNum = 0; // initial slide index (0 ~ 4)

													slideList.style.width = slideWidth
															* (slideLen + 2)
															+ "px";
													...
													let clonedFirst = firstChild
															.cloneNode(true);
													let clonedLast = lastChild
															.cloneNode(true);

													// Add copied Slides
													slideList
															.appendChild(clonedFirst);
													slideList
															.insertBefore(
																	clonedLast,
																	slideList.firstElementChild);
													...
													for (var i = 0; i < slideLen; i++) {
														...
														pageChild += (i === startNum) ? ' dot_active'
																: '';
														pageChild += '" data-index="'
																+ i
																+ '"><a href="#"></a></li>';
													}
													pagination.innerHTML = pageChild;
													const pageDots = document
															.querySelectorAll('.dot'); // each dot from pagination
															...
															.addEventListener(
																	...
																	function() {
																		if (curIndex <= slideLen - 1) {
																			slideList.style.transition = slideSpeed
																					+ "ms";
																			slideList.style.transform = "translate3d(-"
																		...
																		curSlide.classList
																				.remove('slide_active');
																		pageDots[(curIndex === -1) ? slideLen - 1
																				: curIndex].classList
																				.remove('dot_active');
																		curSlide = slideContents[++curIndex];
																		curSlide.classList
																				.add('slide_active');
																		pageDots[curIndex].classList
																				.add('dot_active');
																	});
											...
											<input type="file" id="imgInput" name="sell_img_name1"
												onchange="readURL(this)"> <input type="file"
												id="imgInput" name="sell_img_name2" onchange="readURL(this)">
											<input type="file" id="imgInput" name="sell_img_name3"
				...
				<div class="bor10 m-t-50 p-t-43 p-b-40">
					...
					<div class="tab01">
						...
						<ul class="nav nav-tabs" role="tablist">
							<li class="nav-item p-b-10"><a class="nav-link active" data-toggle="tab" href="#description" role="tab">Description</a>
							</li>
									...
									<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
										<ul class="p-lr-28 p-lr-15-sm">
											...
											<li class="flex-w flex-t p-b-7">
												...
												<span class="stext-102 cl6 size-206"> Black, Blue, Grey, Green, Red, White </span>
											</li>
