...
$(document).ready(
 function btnLike() {
	$("#btnlike1").on("click", function() {
		...
		$("#btnlike2").attr("src","./MainPage/images/icons/icon-heart2.png");
	});
});
								...
								<div class="col-sm-6 col-md-3 col-lg-3 ">
									...
									<div class="shop-item">
										<a
											...
											onerror="this.style.display='none'" width="300px"
											height="400px" alt="Accessories Pack" />
										...
										<!--                    <img src="./MainPage/images/icons/icon-heart1.png" width="30px" height="40px" id="hz" onclick="toggleImage();"/> -->
										<button id="btnlike1" onclick="btnLike()">
											<img id="btnlike2"
												src="./MainPage/images/icons/icon-heart1.png" width="30px"
												height="40px">
										</button>
					...
					<c:choose>
						<c:when test="${pageNum > 1}">
							<input type="button" value="이전"
								onclick="location.href='Product.pr?page=${pageNum - 1}'">
						</c:when>
						<c:otherwise>
							<input type="button" value="이전">
						</c:otherwise>
