...
<!-- 					</button> -->
			...
			<a href= "productDetailPro.pr?sell_num=<%=seller1.getSell_num()%>">상세보기</a>
		<table 	border="1">
				<tr>
					<td colspan="2"><img src="../upload/<%=seller1.getSell_img_real_name() %>" width="350" height="400" alt="IMG-PRODUCT"></td><td></td>	
				</tr>
				<tr>
...
<%-- 							<img src="images/upload/<%=seller1.getSell_img_real_name() %>" alt="IMG-PRODUCT"> --%>
