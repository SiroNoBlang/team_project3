		...
		<div id="com_container">
			<div class=" container d-flex justify-content-center" >     
		        <ul class="pagination shadow-lg">
		            <li class="page-item active"><a class="page-link" href="#"><i class=" "></i> <small>공지사항</small>  </a></li>
		            <li class="page-item  "><a class="page-link" href="#"><i  class=""></i><small>이벤트</small></a></li>                        
