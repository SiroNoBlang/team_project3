...
<head>
<meta charset="UTF-8">
<title>community -  QnA 상세보기 </title>
	    		...
	    		<div class="container">
						<table class="table" >
							...
							<tr>
								...
								<td>${qnaArticle.getQna_content() }</td>
							</tr>
						</table>
						<br>
						<section class="pagination justify-content-center" >
							<input class="page-item page-link listMargin" type="button" value="수정" onclick="location.href='CommunityQnaDeleteForm.ma?qna_num=${param.qna_num}&page=${param.page}'">
