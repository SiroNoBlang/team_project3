<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<footer class="bg3 p-t-75 p-b-32">
		<div class="container">
		<!-- Logo desktop -->		
			<img src="MainPage//images/icons/logo-02.png" alt="IMG-LOGO" class="footerLogo">
			<br>
			<p>
			회사명: (주)COZA STORE &nbsp;|&nbsp; 사업자등록번호: 054-415-8741 &nbsp;|&nbsp; 제휴/협력문의: contact@admin.com <br>
			(본사) 삼한 골든 게이트 빌딩 7층 - 아이티윌 부산교육센터 &nbsp;|&nbsp; 통신판매업신고번호: 제 2022-부산진구-003호<br>
