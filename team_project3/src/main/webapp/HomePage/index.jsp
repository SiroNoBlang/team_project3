...
<link rel="stylesheet" href="adminMainPage/assets/css/main.css" />
<link rel="stylesheet" href="adminMainPage/assets/css/noscript.css" />
<script src="https://developers.kakao.com/sdk/js/kakao.js"></script>
<script src="adminMainPage/assets/js/jquery-3.6.0.js"></script>
				...
				<form method="post" action="LoginPro.ma">
					<div class="fields">
						<div class="field half">
							<label for="member_id">ID</label> <input type="text" name="member_id" id="member_id" />
						</div>
						<div class="field half">
							<label for="member_passwd">Password</label> <input type="password" name="member_passwd" id="member_passwd" />
						</div>
					</div>
					<ul class="actions">
...
<!-- 						</li> -->
			...
			  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.</textarea>
				    	<br><input type="checkbox" name="agree" value="01">동의
				    </fieldset>
				    <fieldset>
				        <legend>개인정보 수집/이용 동의</legend>
				        <textarea rows="20" cols="120">1. 개인정보의 수집항목 및 수집방법 
				    ...
				    <br><input type="checkbox" name="agree" value="02">동의
				    </fieldset>
			...
			<article id="joinPro">
				...
				<form method="post" action="JoinPro.ma" id="fr">
					<div class="fields">
						...
						<div class="field half">
							<label for="member_passwd_check">Password Check</label><span id="passCheck"></span>
							<input type="password" name="member_passwd_check" id="member_passwd_check" /> <span id="member_passwd_check_result"></span>
						</div>
						<div class="field half">
							<label for="member_email1">Email</label> <input type="text" name="member_email1" id="member_email1" />
						</div>
						<div class="field half">
							<label>도메인</label>
						...
						<div class="field half">
							<label for="member_info_gender">성별</label> <select id="member_info_gender" name="member_info_gender">
						...
						<div class="field half">
							<label for="member_info_detail_like_style">Style</label> <select id="member_info_detail_like_style" name="member_info_detail_like_style">
								<option value="귀여움">귀여움</option>
								<option value="섹시함">섹시함</option>
							</select>
						</div>
						<div class="field half">
							<label for="member_info_detail_like_brand">Brand</label> <select id="member_info_detail_like_brand" name="member_info_detail_like_brand">
								<option value="나이키">나이키</option>
								<option value="에르메스">에르메스</option>
							</select>
						</div>
						<div class="field half">
							<label for="member_info_detail_like_category">Like Item</label> <select id="member_info_detail_like_category" name="member_info_detail_like_category">
	...
	<!-- Scripts -->
	<script src="adminMainPage/assets/js/jquery-3.6.0.js"></script>
	<script src="adminMainPage/assets/js/browser.min.js"></script>
	<script src="adminMainPage/assets/js/breakpoints.min.js"></script>
	<script src="adminMainPage/assets/js/util.js"></script>
	<script src="adminMainPage/assets/js/main.js"></script>
