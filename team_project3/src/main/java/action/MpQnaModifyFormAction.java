...
public class MpQnaModifyFormAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		//System.out.println("MpQnaModifyFormAction");
		...
		forward.setPath("MainPage/community/communityQnaModifyForm.jsp");
