...
public class MpEventListAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
//		System.out.println("MpEventListAction");
		...
		request.setAttribute("eventList", eventList); // 게시물 목록 객체
		
		forward = new ActionForward();
		forward.setPath("./MainPage/community/communityEvent.jsp");
