...
public class MpNoticeSearchAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
//		System.out.println("MpNoticeSearchAction");
...
//		System.out.println(searchType);
		...
		forward.setPath("./MainPage/community/communityNoticeSearch.jsp");
