 ...
 *  sell_size
 *  sell_category
 *  sell_category_detail
 *  sell_title, a.sell_color, a.sell_brand, a.sell_price, a.sell_readcount, b.sell_img_name, b.sell_img_real_name, c.sell_list_num
...
public class SellerProductDTO {
	...
	public SellerProductDTO(int sell_num, String sell_member_code, String sell_title, String sell_category,
	...
	public String toString() {
		return "SellerProductDTO [sell_num=" + sell_num + ", sell_member_code=" + sell_member_code + ", sell_title="
				...
				+ ", sell_list_approve_nickname=" + sell_list_approve_nickname + ", sell_img_real_num="
				+ sell_img_real_num + ", sell_img_num=" + sell_img_num + ", sell_img_name=" + sell_img_name
				+ ", sell_img_real_name=" + sell_img_real_name + ", buy_member_code=" + buy_member_code
